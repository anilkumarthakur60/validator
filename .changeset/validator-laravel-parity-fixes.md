...
Laravel-parity fixes for presence, sizing, parsing, messages, dates, UUIDs, and numeric rules. Ten audited divergences from Laravel's validator semantics are corrected:
