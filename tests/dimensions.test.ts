...
let validatorMod: typeof import('@/lib/core/Validator')
let ruleMod: typeof import('@/lib/ruleObjects/Rule')
let fileRuleMod: typeof import('@/lib/ruleObjects/FileRule')
let dimsMod: typeof import('@/lib/ruleObjects/Dimensions')
...
beforeAll(async () => {
  ...
  validatorMod = await import('@/lib/core/Validator')
  ruleMod = await import('@/lib/ruleObjects/Rule')
  fileRuleMod = await import('@/lib/ruleObjects/FileRule')
  dimsMod = await import('@/lib/ruleObjects/Dimensions')
})
